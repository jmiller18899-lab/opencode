...
export const dict = {
  ...
  "dialog.project.open.github": "GitHub repository",
  "dialog.project.open.folder": "Local folder",
  "dialog.project.open.folder.title": "Open a project from this computer",
  "dialog.project.open.folder.description": "Choose one or more existing folders to add to OpenCode.",
  "dialog.project.open.folder.choose": "Choose folder",
  "dialog.project.open.github.connect.title": "Connect your GitHub account",
  "dialog.project.open.github.connect.description":
    "Use a fine-grained personal access token to browse and clone only the repositories you allow.",
  "dialog.project.open.github.token": "Personal access token",
  "dialog.project.open.github.token.create": "Create a fine-grained token on GitHub",
  "dialog.project.open.github.connect": "Connect GitHub",
  "dialog.project.open.github.connecting": "Connecting...",
  "dialog.project.open.github.disconnect": "Disconnect",
  "dialog.project.open.github.sessionOnly":
    "Secure system storage is unavailable, so this connection lasts only until OpenCode closes.",
  "dialog.project.open.github.search": "Search repositories",
  "dialog.project.open.github.empty": "No repositories found.",
  "dialog.project.open.github.private": "Private",
  "dialog.project.open.github.destination": "Clone into",
  "dialog.project.open.github.destination.choose": "Choose destination",
  "dialog.project.open.github.destination.hint": 'Creates a new folder named "{{repository}}".',
  "dialog.project.open.github.clone": "Clone repository",
  "dialog.project.open.github.cloning": "Cloning...",
